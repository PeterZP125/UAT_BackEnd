...
/**
 * @author PeterZP
 * @create 2023-11-03 13:04
 */
public class ResultPage<T> implements IPage<T> {
    ...
    public ResultPage(long current, long size, boolean searchCount) {
        this(current, size, 0L, searchCount);
    }

    public ResultPage(long current, long size, long total, boolean searchCount) {
        this.records = Collections.emptyList();
        this.total = 0L;
        this.size = 10L;
        this.current = 1L;
    ...
    public ResultPage<T> setRecords(List<T> records) {
    ...
    public ResultPage<T> setSize(long size) {
        this.size = size;
        return this;
    }
    ...
    public ResultPage<T> setCurrent(long current) {
        this.current = current;
        return this;
    }
    ...
    public ResultPage<T> addOrder(OrderItem... items) {
        this.orders.addAll(Arrays.asList(items));
        return this;
    }

    public ResultPage<T> addOrder(List<OrderItem> items) {
    ...
    public ResultPage<T> setSearchCount(boolean searchCount) {
        this.searchCount = searchCount;
        return this;
    }

    public ResultPage<T> setOptimizeCountSql(boolean optimizeCountSql) {
